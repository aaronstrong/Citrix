...
#$XenDesktopIsoName = "Citrix_Virtual_Apps_and_Desktops_7_1808_2.iso"
#$XenDesktopIsoPath = "\\192.168.2.99\isos\Citrix\XenApp\7.15 LTSR\XenApp and XenDesktop\"  # Citrix ISO SMB Share path  \\192.168.2.99\isos\Citrix\XenApp\1808
#$XenDesktopIsoPath = "\\192.168.2.99\isos\Citrix\XenApp\1808"
$XenDesktopIsoName = "XenApp_and_XenDesktop_7_6_3000.iso"
$XenDesktopIsoPath = "\\192.168.2.99\ISOs\Citrix\XenApp\7.6 LTSR"
...
for($a=0; $a -lt $totalVMs; $a++) {
    ...
    Invoke-VMScript -VM $vm -ScriptType Bat -ScriptText $cmdIP -Verbose -GuestUser "$domainName\$domainAccount" -GuestPassword "$domainPassword" -Force
